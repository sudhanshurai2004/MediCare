...
export const bannerStyles = {
  bannerContainer: "relative w-full max-w-7xl mx-auto my-8 px-4 sm:px-6",
  mainContainer: "relative overflow-hidden rounded-[28px] bg-white shadow-[0_20px_50px_rgba(16,185,129,0.12)] border border-emerald-100",
  contentContainer: "relative z-20 p-6 sm:p-8 md:p-10 lg:p-12",
  flexContainer: "flex flex-col-reverse lg:flex-row items-center justify-between gap-8 lg:gap-10",
  leftContent: "flex-1 text-center lg:text-left",
  rightImageSection: "flex-1 relative w-full flex justify-center",
  headerBadgeContainer: "flex items-center justify-center lg:justify-start gap-3 mb-2",
  stethoscopeInner: "bg-[#1b7a4e] p-2.5 rounded-full shadow-md",
  stethoscopeIcon: "w-6 h-6 text-white",
  brandMark: "font-sans text-3xl sm:text-4xl font-bold text-gray-900 tracking-tight",
  starsInner: "flex gap-1 justify-center lg:justify-start mt-2 mb-5",
  starIcon: "w-5 h-5 fill-yellow-400 text-yellow-400",
  headline: "font-sans text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight",
  headlineAccent: "text-[#1b7a4e]",
  featuresGrid: "grid grid-cols-1 sm:grid-cols-2 gap-3 mb-7",
  featureItem: "flex items-center justify-center lg:justify-start gap-2 bg-[#e8f6ee] text-[#1b7a4e] px-4 py-2.5 rounded-full text-sm font-semibold",
  featureIcon: "w-4 h-4 shrink-0",
  ctaButtonsContainer: "flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start",
  bookButton: "inline-flex items-center justify-center gap-2 whitespace-nowrap bg-[#1b7a4e] hover:bg-[#16663f] text-white px-7 py-3.5 rounded-full font-semibold shadow-md text-sm sm:text-base",
  bookButtonIcon: "w-5 h-5",
  emergencyButton: "inline-flex items-center justify-center gap-2 whitespace-nowrap bg-[#e57373] hover:bg-[#ef5350] text-white px-7 py-3.5 rounded-full font-semibold shadow-md text-sm sm:text-base",
  emergencyButtonIcon: "w-5 h-5",
  image: "w-full max-w-xl object-contain h-64 sm:h-80 md:h-[380px] lg:h-[420px]",
};
...
export const contactPageStyles = {
  // Page container
  pageContainer: "min-h-screen bg-linear-to-br from-emerald-100 via-white to-emerald-50 py-12 px-4 sm:px-6 md:px-8 lg:px-20 font-sans not-italic relative overflow-hidden",
  ...
  formSubtitle: "text-sm sm:text-md text-emerald-700 mb-6",
...
export const doctorsPageStyles = {
  ...
  headerTitle: "text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-serif font-bold text-[#0f5c3a] mb-3 tracking-tight",
  headerSubtitle: "text-sm sm:text-base text-gray-500 font-light",
...
export const footerStyles = {
  // Main container
  footerContainer: "relative font-sans not-italic bg-linear-to-br from-emerald-50 via-green-50 to-teal-50 border-t border-emerald-200 overflow-hidden",
  ...
  companyName: "text-2xl md:text-3xl lg:text-3xl font-bold bg-linear-to-r from-emerald-600 to-green-700 bg-clip-text text-transparent font-sans not-italic tracking-tight",
  companyTagline: "text-emerald-600 font-sans text-xs md:text-sm font-semibold tracking-wide mt-1",
  companyDescription: "text-emerald-700 font-sans not-italic mb-5 leading-relaxed text-sm md:text-base font-light",
...
export const navbarStyles = {
  ...
  // Content wrapper
  contentWrapper: "max-w-7xl font-sans not-italic md:px-2 mx-auto px-4 sm:px-6 lg:px-8",
  flexContainer: "flex items-center justify-between h-20",
  
  // Logo section
  logoLink: "flex items-center gap-2 min-w-0",
  logoContainer: "relative group w-12 h-12 sm:w-14 sm:h-14 shrink-0",
  logoImageWrapper: "relative flex items-center justify-center overflow-hidden h-full w-full",
  logoImage: "w-12 h-12 sm:w-14 sm:h-14 object-contain rounded-full",
  logoTextContainer: "block min-w-0",
  logoTitle: "text-lg md:text-xl font-serif font-bold not-italic text-[#0f7a4a] leading-tight tracking-tight",
  logoSubtitle: "text-[11px] text-gray-500 leading-tight",
  ...
  loginButton: "btn-login hidden lg:flex lg:text-sm items-center gap-2 bg-linear-to-r from-emerald-400 to-green-600 text-white px-6 py-2.5 rounded-full font-semibold hover:shadow-xl transition-all duration-300 cursor-pointer",
  loginIcon: "w-4 h-4",
  ...
  mobileLoginButton: "w-full cursor-pointer md:rounded-full flex items-center justify-center gap-2 bg-linear-to-r from-emerald-500 to-green-600 text-white py-2.5 rounded-lg font-semibold hover:shadow-lg transition-all",
...
export const testimonialStyles = {
  ...
  // Testimonial card
  testimonialCard: "bg-white font-sans not-italic rounded-xl shadow-lg p-4 sm:p-5 mb-4 transition-transform duration-300 border-l-4 w-full max-w-xl mx-auto",
...
export const navbarStylesDr = {
  // Main navbar
  navContainer: "fixed top-8 left-1/2 -translate-x-1/2 z-50 w-full md:max-w-2xl lg:max-w-4xl px-4 py-0 rounded-full bg-white/80 backdrop-blur-md border border-emerald-100 shadow-2xl flex items-center justify-between gap-3 font-sans not-italic transition-all duration-300 hover:shadow-emerald-200/80 hover:-translate-y-0.5",
  ...
  brandTitle: "text-3xl text-emerald-700 font-sans font-bold not-italic tracking-tight",
